...
import org.example.Islambek.events.IssuedEvent;
...
@Service
public class IssuedService   implements ApplicationEventPublisherAware {
    ...
    public void createIssued(Long bookId, Long userId) {
        ...
        if (product != null && user != null) {
            this.eventPublisher.publishEvent(new IssuedEvent(this, bookId, userId));
